...
-- Set search_path
SET search_path TO assignment1;

-- Drop tables in dependency order
DROP TABLE IF EXISTS assignment1."TaskTag";
DROP TABLE IF EXISTS assignment1."Tag";
DROP TABLE IF EXISTS assignment1."Task";
DROP TABLE IF EXISTS assignment1."Project";
DROP TABLE IF EXISTS assignment1."Department";
...
CREATE TABLE assignment1."TaskTag" (
    ...
    CONSTRAINT "FK_TaskTag_Task"    FOREIGN KEY ("TaskID") REFERENCES assignment1."Task" ("TaskID"),
    CONSTRAINT "FK_TaskTag_Tag"     FOREIGN KEY ("TagID")  REFERENCES assignment1."Tag"  ("TagID")
);
...
FROM assignment1."Department" d
LEFT JOIN assignment1."Project" p ON d."DepartmentID" = p."DepartmentID"
LEFT JOIN assignment1."Task"    t ON p."ProjectID"    = t."ProjectID"
