...
export default function Dashboard() {
  ...
  const activities: Activity[] = [
    { id: 1, type: 'update', text: 'Task "API Integration" marked as Done', time: '2 min ago', color: '#22c55e' },
    { id: 2, type: 'add', text: 'New task created: Testing Phase', time: '15 min ago', color: '#667eea' },
    { id: 3, type: 'update', text: 'Project "Website Redesign" updated', time: '1 hour ago', color: '#f59e0b' },
    { id: 4, type: 'add', text: 'New project added: Mobile App', time: '2 hours ago', color: '#667eea' },
  ...
  return (
    <div className="dashboard">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card-new gradient-red">
          <div className="stat-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="10"/>
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="line-chart-svg">
      ...
      {currentData.map((value, index) => {
        ...
        return (
          <g key={index}>
            <circle cx={x} cy={y} r="4" fill="white" stroke="#667eea" strokeWidth="2" />
            <circle cx={x} cy={y} r="8" fill="rgba(102, 126, 234, 0.2)" className="chart-point" />
          </g>
        );
      })}
