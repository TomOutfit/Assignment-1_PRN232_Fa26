  ...
  return (
    <div className="dashboard">
      ...
      <div className="stats-grid">
        <div className="stat-card-new gradient-cyan animate-fade-in-up">
        ...
        <div className="stat-card-new gradient-blue animate-fade-in-up delay-100">
          <div className="stat-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="stat-card-new gradient-orange animate-fade-in-up delay-200">
          <div className="stat-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="stat-card-new gradient-pink animate-fade-in-up delay-300">
          <div className="stat-card-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="10"/>
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-main">
          {/* Task Overview Chart */}
          <div className="card chart-card animate-fade-in-up delay-200">
          ...
          {/* Task Distribution */}
          <div className="card distribution-card animate-fade-in-up delay-300">
            <div className="card-header">
              <div>
        ...
        <div className="dashboard-sidebar">
          {/* Recent Activities */}
          <div className="card activities-card animate-fade-in-up delay-400">
            <div className="card-header">
          ...
          {/* Quick Stats */}
          <div className="card quick-stats-card animate-fade-in-up delay-500">
            <div className="card-header">
            ...
            <div className="quick-stats-list">
              ...
              <div className="quick-stat-item" style={{ '--stat-color': '#3a86ff', '--stat-glow': 'rgba(58, 134, 255, 0.3)' } as React.CSSProperties}>
                <div className="quick-stat-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3a86ff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Projects Section */}
      <div className="card projects-section animate-fade-in-up delay-500">
        <div className="card-header">
          <div>
      ...
      {/* Recent Tasks Table */}
      <div className="card tasks-section animate-fade-in-up delay-600">
        <div className="card-header">
          <div>
